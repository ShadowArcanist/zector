  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        className="flex h-8 cursor-pointer items-center gap-2 rounded-lg bg-white/8 px-3 text-[13px] text-fg transition-colors hover:bg-white/12"
      ...
      {open &&
        ...
        createPortal(
          <div
            ref={menuRef}
            role="listbox"
            className="fixed z-100 min-w-[160px] rounded-xl border border-white/6 bg-bg2 py-1.5 shadow-modal"
